<?php
    include 'connect.php';
   $edit= mysqli_query($conn,"SELECT * FROM user WHERE Nama='".$_GET['Nama']."'");
...
<body>
    ...
    <header>
        <a href="#">
            <iconify-icon icon="bxs:edit" class="logo"></iconify-icon>
        </a>
        <ul>
            <li>
                <a href="index.php">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="container-content">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="745.78294" height="510"
                viewBox="0 0 745.78294 510" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#f1f1f1" />
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#fff" />
                <path
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#fff" />
                <rect id="e53b7fd6-ae48-4231-a6bf-c74c7a6312f6" data-name="Rectangle 62" x="0.30072" y="19.33529"
                    width="705.26456" height="334.66027" fill="#e6e6e6" />
                <rect id="e27b5d17-8fe1-40fd-abc5-ff1fb7c5af81" data-name="Rectangle 75" x="20.468" y="48.033"
                    width="664.93099" height="279.21753" fill="#fff" />
                <rect id="f11de06d-5237-47a5-bdcf-7ab24c90f6f6" data-name="Rectangle 80" width="705.26456"
                    height="29.96173" fill="#e7b522" />
                <circle id="a8620065-6204-4575-b165-05df1e96cc70" data-name="Ellipse 90" cx="22.26529" cy="15.62776"
                    r="5.5533" fill="#fff" />
                <circle id="b36f18db-17cf-43fd-9307-66e7abd9e79c" data-name="Ellipse 91" cx="43.34377" cy="15.62776"
                    r="5.5533" fill="#fff" />
                <circle id="f951b331-c7b3-4c65-b7ff-4fae542bffe1" data-name="Ellipse 92" cx="64.42323" cy="15.62776"
                    r="5.5533" fill="#fff" />
                <path id="f1fe0bb1-d2c3-44f1-a2df-b8ed042349d0-595" data-name="Path 142"
                    ...
                    transform="translate(-227.10853 -195)" fill="#e6e6e6" />
                <path id="b5b576d4-2c69-432d-bba9-c1d1eb12c444-596" data-name="Path 143"
                    ...
                    transform="translate(-227.10853 -195)" fill="#e6e6e6" />
                <path id="e1a4eb85-7f76-47c7-ae93-e7842353edb9-597" data-name="Path 142"
                    ...
                    transform="translate(-227.10853 -195)" fill="#e6e6e6" />
                <path id="bd9e3462-ca4d-47f6-a5ea-71b97a8587f8-598" data-name="Path 143"
                    ...
                    transform="translate(-227.10853 -195)" fill="#e6e6e6" />
                <path id="f71eedc3-aadd-4340-a501-e921cec01e8f-599" data-name="Path 142"
                    ...
                    transform="translate(-227.10853 -195)" fill="#e6e6e6" />
                <path id="b1fed777-acdd-4ce8-9b40-ebd2535d8bb3-600" data-name="Path 143"
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#fff" />
                <circle id="b315fec5-366f-4a16-9dc9-634679b82ba4" data-name="Ellipse 188" cx="152.29372" cy="150.53123"
                    r="8.349" fill="#2f2e41" />
                <path id="fd00c811-5154-4e0f-bd90-f718730f637f-601" data-name="Path 969"
                    d="M381.72829,337.41224a8.35,8.35,0,0,1,7.35,12.312,8.347,8.347,0,1,0-13.868-9.172,8.32914,8.32914,0,0,1,6.519-3.14Z"
                    transform="translate(-227.10853 -195)" fill="#2f2e41" />
                <circle id="b073881c-6d17-4b63-9208-a633e233f752" data-name="Ellipse 189" cx="136.69172" cy="125.98723"
                    r="24.526" fill="#2f2e41" />
                <path id="e068fb34-c64f-4621-9a6c-47926968fe63-602" data-name="Path 970"
                    ...
                    transform="translate(-227.10853 -195)" fill="#2f2e41" />
                <circle id="baa61e83-3b6b-4f74-a8d9-0c51f3f7a212" data-name="Ellipse 190" cx="136.48371" cy="134.50923"
                    r="15.796" fill="#a0616a" />
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#cbcbcb" />
                <path
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#2f2e41" />
                <path id="b5d95f6e-bcc4-4382-8a9f-8ff393651dfe-603" data-name="Path 975"
                    d="M350.08223,309.76422v15.8h3.658l4.655-4.988-.623,4.988h16.17l-1-4.988,2,4.988h2.578v-15.8Z"
                    transform="translate(-227.10853 -195)" fill="#2f2e41" />
                <ellipse id="a1555f60-b18f-4a81-9968-ab91697ea211" data-name="Ellipse 191" cx="120.47972" cy="131.18423"
                    rx="1.247" ry="2.286" fill="#a0616a" />
                <ellipse id="b9487e3b-2bf5-437d-8cc7-b19d17f64c32" data-name="Ellipse 192" cx="152.48872" cy="131.18423"
                    rx="1.247" ry="2.286" fill="#a0616a" />
                <path
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#ffb7b7" />
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#e7b522" />
                <polygon points="569.599 494.016 553.795 494.015 546.277 433.059 569.601 433.06 569.599 494.016"
                    fill="#ffb7b7" />
                <path
                    d="M800.7373,704.3346l-50.95641-.00189v-.64452a19.83474,19.83474,0,0,1,19.83366-19.83334h.00126l31.12244.00126Z"
                    transform="translate(-227.10853 -195)" fill="#2f2e41" />
                <polygon points="719.25 477.453 704.614 483.412 674.665 429.791 696.268 420.997 719.25 477.453"
                    fill="#ffb7b7" />
                <path
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#2f2e41" />
                <circle cx="624.43016" cy="101.50853" r="24.7683" fill="#ffb7b7" />
                <path
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#3f3d56" />
                <path
                ...
                <path
                    ...
                    transform="translate(-227.10853 -195)" fill="#e7b522" />
                <path d="M969.73631,705h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z" transform="translate(-227.10853 -195)"
                    fill="#cbcbcb" />
            </svg>
            <div class="content1">
                <p style="margin-bottom: 15px;margin-top:15px; font-weight:800;font-size:larger;color:#212A3E;">Edit
                    Data
                </p>
                <table style="margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="Ttl" value="<?php echo $result ['Ttl']; ?>" required></td>
                    </tr>
                    <tr>
                        <td>Jekel</td>
                        ...
                        <td>
                            <select name="Jekel" ?>">
                                <option value="Laki-laki" <?php if($result['Jekel']== 'Laki-laki'){echo'selected';} ?>>
                                    Laki-Laki</option>
                                <option value="Perempuan" <?php if($result['Jekel']== 'Perempuan'){echo'selected';} ?>>
                                    Perempuan</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="file" name="Foto" <?php if(!!isset($_GET['Edit'])){echo"required";}?>></td>
                    </tr>
                    <tr>
                        <td>Pekerjaan</td>

                        <td><input type="text" name="Pekerjaan" value="<?php echo $result ['Pekerjaan']; ?>" required>
                        </td>
                    </tr>
                </table>
                <input type="submit" name="Edit" value="Simpan" class="button">
            </div>
        </div>
    ...
    if (isset($_POST['Edit'])){
        ...
        if ($nama==''){
            ...
            $photo=$nama;
            unlink('inputimg/'.$result['Foto']);
            move_uploaded_file($file_tmp,'inputimg/'.$nama);
        ...
        Pekerjaan='".$_POST['Pekerjaan']."'
            ...
            ");
            if($update){
                echo '<p style="margin-top:-50px;margin-left:66%; text-align:center;color:#0ad406;display:flex;font-weight:400;"><iconify-icon icon="ep:success-filled" style="color: #0ad406;" width="19" height="19"></iconify-icon>Berhasil di Edit</p>';
            }else{
                echo "❌ Gagal di edit";
            }
    }
